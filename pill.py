...
def paste_forecast_icons(canvas:Image, forecast_codes:list, y_pos:int):
    '''
...
def create_text_elements(city:str, temp:str, datetime:str, forecast_temps:list, accent:str, y_pos:int):
    '''
    ...
    datetime = Text(datetime,   (100, 80),  Font.CONDENSED,         accent              )
...
def create_weather_card_hourly(city: str, current_temp:str, current_code:str, time:str, forecast:list, forecast_codes:list, progress=int):
    ...
    # Creating Text elements
    text = create_text_elements(city, current_temp, time, forecast, accent, forecast_pos_y)
...
def create_tomorrow_forecast(city:str, avg_temp:str, condition_code:str, date:str, forecast:list, forecast_codes:list):
    '''
    ...
    # Loading and pasting forecast icons
    canvas = paste_forecast_icons(canvas, forecast_codes, tomorrow_icons_pos_y)

    # CREATING TEXT ELEMENTS
    text = create_text_elements(city, avg_temp, date, forecast, accent, tomorrow_text_pos_y)
